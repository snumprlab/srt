...
if OPENAI_BACKEND == 'azure':
    ...
    try:
        ...
        assert OPENAI_KEY is not None, "OPENAI_KEY is not configured"
...
def chatgpt_inference(data, prompt_template, output_dir, output_path, num_tasks=1,  
    ...
    while True:
        ...
        # output_dir: /dataset/LLaVA-Hound-DPO/dataset/video_instruction/test_result/msrvtt/eval_test_official_gpt-3.5-turbo-0613/llava_hound_dpo_rep
        # output_path: /dataset/LLaVA-Hound-DPO/dataset/video_instruction/test_result/msrvtt/eval_test_official_gpt-3.5-turbo-0613/llava_hound_dpo_rep.jsonl
        ...
        #print("length data:" , len(data)) # 4134 for msrvtt
        #print(data[0])
        # {'id': 'v_video7012_0', 'variables': {'question': 'what is a suit man doing?', 'answer': 'talk', 'prediction': 'The man in the suit appears to be engaged in a discussion or presentation, as indicated by his hand gestures and facial expressions. He is likely explaining or discussing topics related to psychological disorders.'}}
